...
ids.forEach(id => {
    ...
    wallDirections.forEach(dir => {
        const controlIds = [
            ...
            `overhang-tilt-${dir}`, `overhang-tilt-${dir}-val`, `overhang-depth-${dir}`, `overhang-depth-${dir}-val`, `overhang-thick-${dir}`, `overhang-thick-${dir}-val`,
            `overhang-left-extension-${dir}`, `overhang-left-extension-${dir}-val`, `overhang-right-extension-${dir}`, `overhang-right-extension-${dir}-val`,
          ...
          `shading-controls-imported_obj-${dir}`,
          `shading-obj-file-${dir}`,
